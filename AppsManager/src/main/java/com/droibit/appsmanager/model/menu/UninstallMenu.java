package com.droibit.appsmanager.model.menu;
...
import com.droibit.appsmanager.fragment.UninstallGridFragment;
...
public class UninstallMenu extends FragmentMenu implements SearchView.OnQueryTextListener {
    ...
    public boolean onQueryTextChange(String newtext) {
        if (newtext != null) {
            ((AppArrayAdapter) listView.getAdapter()).getFilter().filter(newtext);
            return true;
        }
        return false;
    }
